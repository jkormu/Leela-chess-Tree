...
class DataCreator:
    ...
    def create_demo_data(self):
        ...
        param1 = ['--cpuct=2.147', '--minibatch-size=1', '--threads=1', '--max-collision-events=1', '--max-collision-visits=1']
        param2 = ['--cpuct=4.147', '--minibatch-size=1', '--threads=1', '--max-collision-events=1', '--max-collision-visits=1']
        nodes = 20
